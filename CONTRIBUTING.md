...
4. The use of AI is not allowed for this project, and any PRs suspected to have been written by AI will be rejected. This rule extends to any documentation and external resources for the project, as well as code or documentation analysis, in general: do not use AI to contribute to this project and do not use AI on the existing code of the project.
